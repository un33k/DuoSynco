...
class STTAudioTranscriber:
    ...
    def transcribe_audio_file(
        ...
        logger.info("Detected %d speakers, %.1fs duration", len(result['speakers']), total_duration)
    ...
    def transcribe_with_custom_settings(
        ...
        utterances, transcript_text, total_duration = self.stt_provider.convert_to_diarization_format(stt_result)
        ...
        logger.info("Custom STT transcription completed: %d speakers, %.1fs", 
                   len(result['speakers']), total_duration)
    ...
    def _calculate_stats(
        ...
        stats['average_utterance_duration'] = total_speech_time / len(utterances) if utterances else 0.0
    ...
    def supported_formats() -> List[str]:
        ...
        return [
            ...
            '.mp4', '.avi', '.mov', '.mkv', '.webm', '.wmv'   # Video formats
        ]
